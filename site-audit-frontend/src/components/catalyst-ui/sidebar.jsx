...
export const SidebarItem = forwardRef(function SidebarItem(
  { current, className, children, showIndicator, disableIndicatorAnimation, ...props },
  ref
) {
  let classes = clsx(
    // Base
    ...
    // Hover
    'data-hover:bg-[#00000004] data-hover:*:data-[slot=icon]:fill-zinc-950',
    // Active
    'data-active:bg-[#00000004] data-active:*:data-[slot=icon]:fill-zinc-950',
    // Current
    ...
    <span className={clsx(className, 'relative')}>
      {current && showIndicator && (
        disableIndicatorAnimation ? (
          <span
            className="absolute top-2 bottom-2 -left-4 w-0.5 rounded-full bg-zinc-950 dark:bg-white"
